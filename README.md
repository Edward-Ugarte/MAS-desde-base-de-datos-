...
- El nivel de confianza así como cualquier parámetros o estadístico dependiendo si es poblacional o muéstral  así mismo se puede utilizar las distintas fórmulas ya  sea censo o encuesta
- (modificando `Z`)
